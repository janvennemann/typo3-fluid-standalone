 ...
 * @api
 */
abstract class AbstractBackend implements \TYPO3\Fluid\Cache\Backend\BackendInterface {
	...
	/**
	 * @var \TYPO3\Fluid\Utility\Environment
	 */
	 ...
	 *
	 * @param \TYPO3\Fluid\Utility\Environment $environment
	 * @return void
	 */
	public function injectEnvironment(\TYPO3\Fluid\Utility\Environment $environment) {
	 ...
	 *
	 * @param \TYPO3\Fluid\Cache\Frontend\FrontendInterface $cache The frontend for this backend
	 * @return void
	 * @api
	 */
